...
class ProfileCard extends StatefulWidget {
  const ProfileCard({super.key, required this.identity, required this.onChanged});
                  ...
                  children: [
                    if (_editing)
                      TextField(
                        controller: _ctrl,
                        autofocus: true,
                        style: AppTextStyles.idName.copyWith(color: Colors.white),
                      ...
                      Row(
                        children: [
                          ...
                          GestureDetector(
                            ...
                            child: AppIcon(AppIconName.edit, size: 16, color: Colors.white.withValues(alpha: 0.85)),
                          ),
                        ],
                      ),
          ...
          Wrap(
            ...
            children: [
              for (final h in _hueSwatches)
                GestureDetector(
                  onTap: () => widget.onChanged(widget.identity.copyWith(hue: h)),
                  child: Container(
                    width: 28,
                    height: 28,
                    decoration: BoxDecoration(
                      ...
                      boxShadow: me.hue == h
                          ? [BoxShadow(color: Colors.white.withValues(alpha: 0.4), blurRadius: 2, spreadRadius: 2)]
                          : null,
                    ),
                  ),
                ),
