...
class IncomingDialogContent extends StatelessWidget {
  const IncomingDialogContent({super.key, required this.request, this.onAccept, this.onDecline});
        ...
        children: [
          ...
          Container(
            ...
            child: Center(
              child: Column(
                children: [
                  Avatar(hue: request.hue, type: request.type, size: 64, radius: 22),
                  const SizedBox(height: 12),
                  Text(request.peer,
                      style: AppTextStyles.idName.copyWith(color: Colors.white, fontSize: 17)),
                  const SizedBox(height: 3),
                  Text('می‌خواهد برایت محتوا بفرستد',
                      style: AppTextStyles.idMeta.copyWith(color: Colors.white.withValues(alpha: 0.9))),
                ],
              ),
            ),
          ),
                    ...
                    child: Row(
                      children: [
                        Container(
                          ...
                          child: Center(
                            child: AppIcon(it.icon, size: 19, stroke: 2, color: Colors.white),
                          ),
                        ),
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(it.size, style: AppTextStyles.fileSub.copyWith(color: c.muted)),
                            ],
                          ),
                        ),
                      ],
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                Text('مجموع', style: AppTextStyles.setLabel.copyWith(color: c.muted, fontWeight: FontWeight.w600)),
                Text('${toFa(request.items.length)} مورد · ${request.total}',
                    style: AppTextStyles.fileName.copyWith(color: c.primary, fontWeight: FontWeight.w800)),
              ],
            ),
          ),
          // Actions
